    ...
    <div className="dashboard-layout">
      ...
      <main className="dashboard-main">
        ...
        <header className="dashboard-header">
          ...
          <div className="header-right">
            ...
            <div className="header-user-info" style={{borderLeft: '1px solid var(--border-color)', paddingLeft: 'var(--spacing-4)', marginLeft: 'var(--spacing-2)'}}>
              <span className="header-user-name">Administrator Utama</span>
              <span className="header-user-detail" style={{textTransform: 'uppercase', letterSpacing: '0.5px'}}>Super Administrator</span>
            </div>
            <div className="header-avatar" style={{background: 'var(--color-primary-500)', color: 'white'}}>AD</div>
          </div>
        </header>
        ...
        <footer className="dashboard-footer">
          <span>UIN Walisongo Semarang - SiKelas © 2024. Semua Hak Dilindungi.</span>
